...
ALPRConfig.command = 'alpr' -- Command to enable alpr system.
ALPRConfig.showROInfo = false-- Not created yet, in place once added.
ALPRConfig.useExpire = false -- true/false
ALPRConfig.useDestroyed = false -- true/false
ALPRConfig.useImpounded = false -- true/false
ALPRConfig.useRevoked = false -- true/false
ALPRConfig.useStolen = false -- true/false
ALPRConfig.useInsurance = false -- true/false
ALPRConfig.useWanted = false -- true/false
ALPRConfig.useRoWanted = false -- true/false
ALPRConfig.ignoreVehicles = {18} -- Vehicle Class

-- Logo URL
TRP911Config.LogoUrl = 'https://i.postimg.cc/NLqN2QKf/OCC-Logo-2refined.png'

-- Dropdown call types
TRP911Config.CallTypes = {
    { group = "Assault/Battery", types = { 'Assault', 'Assault w/ Deadly Weapon', 'Battery', 'Fight in Progress' } },
    { group = "Burglary", types = { 'Burglary - Business', 'Burglary - Residential', 'Burglary - Vehicle', 'Burglary - Other', 'Attempted Burglary' } },
    { group = "Disturbance", types = { 'Public Disturbance', 'Disorderly Conduct', 'Trespassing', 'Noise Complaint', 'Court Order Violation', 'Suspicious Person(s)', 'Suspicious Vehicle(s)', 'Individual in Distress' } },
    { group = "Drugs/Alcohol", types = { 'Intoxicated Person(s)', 'Distribution of Controlled Substance(s)', 'Posession of Narcotic(s)', 'Posession of Drug Paraphanilia', 'Public Intoxication', 'Substance Abuse', 'Drug Overdose', 'Drug Manufacturing', 'Drug Dealing', 'Drug Trafficking' } },
    { group = "Fire/Arson", types = { 'Structure Fire', 'Vehicle Fire', 'Vessel Fire', 'Dumpster Fire', 'Possible Fire' } },
    { group = "Fraud", types = { 'Check Fraud', 'Retail Fraud', 'Scam(s)', 'Identity Theft', 'Impersonation', 'Counterfit Goods', 'False Identification', 'Counterfitting/Forgery', 'Fraudulent Use of Debit/Credit Card', 'Mail Tampering', 'License Plate Tampering', 'Failure to Pay' } },
    { group = "Homicide", types = { 'Deceased Person(s)', 'Murder', 'Vehicular Homicide', 'Mass Casualty Event' } },
    { group = "Intoxicated Driver", types = { 'Intoxicated Driver (Alcohol)', 'Intoxicated Driver (Drugs)' } },
    { group = "Kidnapping", types = { 'Kidnapping', 'Armed Kidnapping', 'Hostage Situation' } },
    { group = "Robbery", types = { 'Robbery (Unarmed)', 'Armed Robbery', 'Mugging' } },
    { group = "Sex Crimes", types = { 'Indecent Exposure', 'Sexual Assault', 'Sexual Battery', 'Sexual Harassment', 'Stalking', 'Lewd Acts in Public', 'Prostitution', 'Rape', 'Pornography/Obscene Material' } },
    { group = "Stolen Vehicle", types = { 'Carjacking', 'Grand Theft Auto', 'Stolen Vehicle' } },
    { group = "Theft", types = { 'Shoplifting', 'Theft - Property', 'Theft - Animal', 'Theft - Other', 'Grand Theft', 'Mail Theft', 'License Plate Theft' } },
    { group = "Traffic Accident", types = { 'Motor Vehicle Collision', 'Pedestrian Struck', 'Disabled Vehicle', 'Hit and Run', 'Road Rage', 'Reckless Driving' } },
    { group = "Vandalism", types = { 'Destruction of Property', 'Vandalism' } },
    --{ group = "Vehicle Burglary", types = { 'Vehicle Burglary' } },
    { group = "Weapons", types = { 'Brandishing a Weapon (Non-Firearm)', 'Brandishing a Firearm', 'Possession of Firearm', 'Possession of a Weapon', 'Discharge of a Firearm', 'Possession of Explosive(s)', 'Discharge of Fireworks' } },
    { group = "Other", types = { 'Road Obstruction', 'Traffic Hazard', 'Wellfare Check', 'Other' } }
}

TRP911Config.streetNames = {
    ...
    ["Runway1"] = "Runway1",
    ["Palomino Fwy"] = "San Andreas Route 15",
    ["Perth St"] = "Perth St",
    ["Milton Rd"] = "Milton Rd",
    ["Tackle St"] = "Tackle St",
    ...
    ["Alta St"] = "Alta St",
    ["Senora Fwy"] = "San Andreas Route 13",
    ...
    ["Great Ocean Hwy"] = "San Andreas Route 1",
    ...
    ["Boulevard Del Perro"] = "Del Perro Boulevard",
    ["Greenwich Pl"] = "Greenwich Pl",
    ["Tongva Dr"] = "Tongva Dr-SA Route 11",
    ["Lolita Ave"] = "Lolita Ave",
    ["Kortz Dr"] = "Kortz Dr",
    ["Lindsay Circus"] = "Lindsay Circus",
    ["Route 68"] = "SA Route 68",
    ...
    ["Didion Dr"] = "Didion Dr",
    ["Elysian Fields Fwy"] = "San Andreas Route 20",
    ["Cholla Rd"] = "Cholla Rd",
    ...
    ["South Boulevard Del Perro"] = "South Del Perro Boulevard",
    ["Nikola Ave"] = "Nikola Ave",
    ["Fort Zancudo Approach Rd"] = "Zancudo Approach Rd",
    ["Tug St"] = "Tug St",
...
TRP911Config.zoneNames = {
    ...
    ["Galileo Park"] = "Galileo Park",
    ["Mount Chilliad"] = "Mount Chilliad",
    ["North Yankton"] = "North Yankton",
    ["Los Santos County"] = "Los Santos County",
    ...
    ["Harmony"] = "Harmony",
    ["N.O.O.S.E"] = "Palomino Police HQ",
    ["Paleto Forest"] = "Paleto Forest",
    ["Bolingbroke Penitentiary"] = "Bolingbroke Penitentiary",
    ["Chiliad Mountain State Wilderness"] = "Chiliad Mountain National Park",
    ["Vinewood"] = "Vinewood",
    ["Banning"] = "Banning",
    ...
    ["Fort Zancudo"] = "Zancudo Public Safety Training & Education Facility",
